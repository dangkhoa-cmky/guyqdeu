            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Giáng sinh zui ze nha!!! Chúc bản thân luôn thành công trên con đường đã chọn. Một mùa Noel thật ấm áp nha! Chúc Hoa một mùa Giáng sinh tràn đầy yêu thương và hạnh phúc, mong mọi điều tốt đẹp sẽ đến với bạn trong năm mới!.",
                        ],
                        typeSpeed: 250,
                        startDelay: 100,
                        backSpeed: 500,
